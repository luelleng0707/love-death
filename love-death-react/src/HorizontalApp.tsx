...
function App() {
  ...
  // Handle scroll-based section navigation
  useEffect(() => {
      ...
      <div className="horizontal-scroll-container" ref={containerRef}>
        ...
        <section className="story-section intro-section" id="intro">
          <div className="section-content">
            ...
            <p className="explanation-text">
              Scroll horizontally to explore five distinct narratives that examine love's complexity 
        ...
        <section className="story-section romeo-juliet" id="romeo-juliet">
          <div className="section-content">
            ...
            <p className="section-subtitle">Shakespeare's Timeless Tragedy</p>
            ...
            <p className="explanation-text">
              Shakespeare's Romeo and Juliet remains the archetypal story of star-crossed lovers. 
        ...
        <section className="story-section lust-caution" id="lust-caution">
          <div className="section-content">
            ...
            <p className="section-subtitle">Ang Lee's Dangerous Liaisons</p>
            ...
            <p className="explanation-text">
              ...
              where a young woman's mission to seduce a collaborator becomes a game of emotional survival.
            </p>
          </div>
        </section>
        ...
        <section className="story-section contemporary" id="contemporary">
          <div className="section-content">
            ...
            <p className="explanation-text">
              Today's love stories unfold across screens and apps, where connection happens instantly 
        ...
        <section className="story-section future" id="future">
          <div className="section-content">
            ...
            <p className="section-subtitle">Love in Tomorrow's World</p>
